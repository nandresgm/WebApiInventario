...
namespace WebApiInventario.Controllers
{
    ...
    {
        private readonly WebApiInventarioContext _context;

        public InventariosController(WebApiInventarioContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Inventario>> PostInventario(Inventario inventario)
        {
          if (_context.Inventario == null)
          {
              return Problem("Entity set 'WebApiInventarioContext.Inventario'  is null.");
          }
